...
public class UserView {
	...
	public void mainMenu() {
		...
		do {
			try {
				...
				System.out.println("3. User 중 이름에 검색어 포함된 회원 조회(SELECT)");
	...
	/**
	 * 3. User 중 이름에 검색어 포함된 회원 조회 Service메서드
	 * @param keyword
	 * @return searchList
	 * @throws Exception
	 */
	private void selectName() throws Exception{	
		...
		// 서비스(SELECT) 호출후 결과(List<User>) 반환 받기
